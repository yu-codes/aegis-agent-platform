...
class FAISSVectorStore(VectorStore):
    ...
    def _initialize_index(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "faiss required. Install with: pip install faiss-cpu " "or pip install faiss-gpu"
            )
    ...
    async def add_batch(
        ...
        # Store mappings
        for i, (id, content, metadata) in enumerate(zip(ids, contents, metadatas, strict=False)):
...
class MilvusVectorStore(VectorStore):
    ...
    async def add_batch(
        ...
        data = [
            ...
            for id, embedding, content, metadata in zip(
                ids, embeddings, contents, metadatas, strict=False
            )
        ]
...
class InMemoryVectorStore(VectorStore):
    ...
    async def add_batch(
        ...
        metadatas = metadatas or [{}] * len(ids)
        for id, emb, content, meta in zip(ids, embeddings, contents, metadatas, strict=False):
