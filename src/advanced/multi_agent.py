...
class LLMAgent(Agent):
    ...
    async def process(
        ...
        # Build prompt
        system = self.definition.system_prompt or f"You are {self.definition.name}, a {self.definition.role.value}."
...
class AgentPool:
    ...
    def __init__(self):
        ...
        self._by_role: dict[AgentRole, list[UUID]] = {
    ...
    def get_by_role(self, role: AgentRole) -> list[Agent]:
        ...
        return [
            self._agents[aid] for aid in self._by_role.get(role, [])
