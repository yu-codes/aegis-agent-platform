...
from src.domains import DomainRegistry, DomainProfile
...
async def list_domains(
    ...
    for profile in registry:
        summaries.append(DomainSummary(
            ...
            allowed_tools_count=len(profile.tools.allowed_tools) if profile.tools.allowed_tools else None,
...
async def get_domain(
    ...
    return DomainDetail(
        ...
        prompt_preview=profile.prompt.system_prompt[:300] + "..." if len(profile.prompt.system_prompt) > 300 else profile.prompt.system_prompt,
